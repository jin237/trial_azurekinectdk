...
from pykinect_azure.k4a import Device, _k4a, default_configuration
from pykinect_azure.k4abt import Tracker, _k4abt
...
from pykinect_azure.utils import (
    get_k4a_module_path, get_k4abt_module_path,
